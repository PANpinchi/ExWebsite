  ...
  <?php
    ...
    <table border="1" class="c" style="border-style:solid; width: 1100px;">
	  ...
	  <tr>
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction2'].'>
 				 </div>
	  <tr>
		  <th>3
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction3'].'>
 				 </div>
	  <tr>
		  <th>4
		  <th >高一在校學業成績比對差異回報系統
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction4'].'>
 				 </div>
	  <tr>
		  <th>5
		  <th>下載證號不符學生名冊檔案
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction5'].'>
 				 </div>
	  <tr>
		  <th>6
		  <th>登錄「繁星推薦」報名作業系統
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction6'].'>
 				 </div>
	  <tr>
		  <th>7 
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction7'].'>
 				 </div>
	  <tr>
		  <th>8
		  <th>推薦學校列印報名費收據
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction8'].'>
 				 </div>
	  <tr>
		  <th>9
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
                 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction9'].'>
 				 </div>
	  <tr>
		  <th>10
		  <th >集報考生個人密碼設定情形查詢系統
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction10'].'>
 				 </div>
	  <tr>
		  <th>11
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction11'].'>
 				 </div>
	  <tr>
		  <th>12
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction12'].'>
 				 </div>
				  <tr>
		  <th>13
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction13'].'>
 				 </div>
	  <tr>
		  <th>14
		  <th>甄選入學意見調查作業
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction14'].'>
 				 </div>
	  <tr>
		  <th>15
		  ...
		  <th> <div class="mb-3">
   				 <label for="help" class="form-label"></label>
   				 <input type="help" class="form-control" id="help" name="instruction1" value='.$starsenior_item['instruction15'].'>
 				 </div>
