        ...
        foreach($starcollege as $starcollege_item){
            ...
            if (strtotime($starcollege_item['start1'])<strtotime(date("Y-m-d H:i:s")) && strtotime(date("Y-m-d H:i:s"))<strtotime($starcollege_item['end1']))
                echo'
                    ...
                    <script>
                        function test(){
                            window.open("'.$starcollege_item['website1'].'");
                        }
                    </script>
                ';
            else{
