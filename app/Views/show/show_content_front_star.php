            ...
            <td align="center">
                ...
                <table class="table table-bordered" style="width: 700px; margin-right: 10px">
                    ...
                    <tr>
                        ...
                        <?php echo' <td style="width: 600px;"> <strong>'.$star_post_page['subtitle'].'</strong> </td> '; ?>
                    </tr>
                    <tr>
                    ...
                    if($star_post_page['file'] != NULL){
                        echo '
                            <tr>
                                ...
                                <td><a href="/viewController/show_pdf/'.$star_post_page['file'].'">'.$star_post_page['file_name'].'</a>
                            </tr>';
                    }
                    else{
                        echo '
                ...
                <a class="btn btn-primary" href="/viewController/show_front_star" style="margin-right: 30px; background-color: rgb(255, 174, 172); border-color: rgb(255, 174, 172);">返回</a>
                <br><br>
            </td>
        </tr>
    <body>
