            ...
            <div align="center">
                <div>
                    ...
                    <button class="btn btn-primary" style="background-color:orange; border-color:orange;">
                        <a href="/starController/modify_star" style="color:white; text-decoration:none;"> 修改公告 </a>
                    </button>
                    <button class="btn btn-primary" style="background-color:red; border-color:red;">
                        <a href="/starController/delete_star" style="color:white; text-decoration:none;"> 刪除公告 </a>
                    </button>
                </div>
            </div>
            <br>
